...
module Data =
    ...
    //from https://github.com/emmadoughty/Daily_COVID-19/blob/master/Data/COVID19_deaths.csv
    let actcumdthsld = 335.0
    let trange = [|65..85|]
    let tactcumdths = [|1.0;2.0;2.0;3.0;6.0;6.0;8.0;10.0;21.0;35.0;55.0;71.0;103.0;144.0;177.0;233.0;281.0;335.0;422.0;463.0;578.0;759.0;1019.0;1228.0|]

    let start = DateTime(2020,1,1)
    let currdt t = start.AddDays(float(t))
    ...
    let hosp_prop = [|0.001;0.003;0.012;0.032;0.049;0.102;0.166;0.243;0.273|]
    let cc_prop = [|0.05;0.05;0.05;0.05;0.063;0.122;0.274;0.432;0.709|]
    let ifr = [|0.00002;0.00006;0.0003;0.0008;0.0015;0.006;0.022;0.051;0.093|]
